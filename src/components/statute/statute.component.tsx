  ...
  return (
    <div className={styled.statue}>
      ...
      <p className={styled.info}>
        Szanowny Użytkowniku, 1. Wszelkie dane przechowywane (zapisane) w
        urządzeniu w tym m.in. zdjęcia, lista kontaktów, nagrania, zawartość
        aplikacji, karta pamięci powinny zostać usunięte przed przekazaniem
        urządzenia do serwisu. informujemy, iż w trakcie dokonywania czynności
        serwisowych, naprawy lub wymiany wadliwego lub uszkodzonego urządzenia,
        mogą ulec utracie, uszkodzeniu lub zniszczeniu treści lub dane
        przechowywane (zapisane) w urządzeniu. Informujemy, że nie posiadamy w
        swojej ofercie usługi kopiowania/odzyskiwania danych zapisanych w
        pamięci urządzeń. 2. Czynności serwisowe prowadzone przez serwis mogą
        wymagać demontażu zabezpieczenia ekranu w postaci folii lub szkieł
        ochronnych bez możliwości ponownego ich montażu. Za zdemontowane ochrony
        ekranu nie ponoszą odpowiedzialności serwis oraz Xiaomi Store. 3. W
        przypadku zgłoszenia urządzenia w celu naprawy i braku akceptacji
        ...
        technicznej oraz transportu urządzenia w kwocie 75 zł. Kwota nie
